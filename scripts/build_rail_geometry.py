...
AXES = [
    ...
    },
    {
        ...
        "mode": "spliced",
        # 서울역 직결이 실재한다. 데모일 실측(runInfo2·runPlan2, 2026-08-10)에서 서울→전주
        # 5편/일(00503·00507·00511·00515·00517), 전주→서울 6-7편/일(00502·00504·00508·
        # 00514·00516·00520·00544)이고 TAGO 등급으로 12편 전부 KTX 계열이다.
        #
        # 그런데 OSM에는 서울역에서 출발하는 전라선 관계가 없다 — 이 열차들의 종단이
        # 행신·여수엑스포라 관계가 "용산 → 전주"로만 등록돼 있고, 서울역은 진부와 같은
        # 중간 정차 구조로 들어간다. 실제 운행은 행신 - 서울 - 용산 - ... - 전주 순이라
